...
values
  (
    ...
    'Shopping',
    E'- [ ] milk\n- [ ] spinach',
    '{"schemaVersion":1,"items":[{"id":"itm_00000000000000000000000001","text":"milk","checked":false,"ordinal":0,"section":null},{"id":"itm_00000000000000000000000002","text":"spinach","checked":false,"ordinal":1,"section":null}]}'::jsonb,
    2,
    '2026-08-30',
    'ai_assisted',
  ...
  (
    ...
    'log',
    'Push Workout',
    E'## 2026-08-30T16:06:00.000Z\n\n- workout: bench 135 x 8, 145 x 6',
    '{"schemaVersion":1,"entries":[{"id":"ent_00000000000000000000000001","occurredAt":"2026-08-30T16:06:00.000Z","fields":{"workout":"bench 135 x 8, 145 x 6"}}]}'::jsonb,
    1,
    null,
    'ai_assisted',
...
values
  (
    ...
    'Shopping',
    '- [ ] milk',
    '{"schemaVersion":1,"items":[{"id":"itm_00000000000000000000000001","text":"milk","checked":false,"ordinal":0,"section":null}]}'::jsonb,
    true,
    null,
    'ai_assisted',
    null,
...
values (
  ...
  null,
  null,
  '["tag_00000000000000000000000001"]'::jsonb,
  '[]'::jsonb,
