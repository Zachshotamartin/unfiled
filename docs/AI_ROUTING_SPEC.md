...
- **OpenAI — implemented (Milestone D, extended by ADR-0015); live report pending:** Responses API, strict Structured Outputs, `store: false`, `model` from the job snapshot, `reasoning.effort` low/medium/high.
