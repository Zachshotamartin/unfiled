...
- the Inbox holds only captures that need the owner, a review explains why Unfiled stopped and takes the owner's directions ("Organize again"), and a stopped capture can be deleted (ADR-0019, decision 9);
