...
final class ReviewViewTests: XCTestCase {
    ...
    private func reviewCapture(
        ...
        let json = #"{"id":"cap_00000000000000000000000000","rawContent":"oat milk","source":"mobile","deviceId":"device-1","privacy":"ai_assisted","explicitDestinationNoteId":null,"expansionDisabled":false,"clientCreatedAt":"2026-09-01T12:00:00Z","clientTimezone":"UTC","receivedAt":"2026-09-01T12:00:01Z","status":"needs_review","lastErrorCode":null,"attachments":[],"jobId":"job_00000000000000000000000000","receipt":{"schemaVersion":1,"captureId":"cap_00000000000000000000000000","jobId":"job_00000000000000000000000000","decisionId":\#(encodedDecision),"reviewItemId":"\#(reviewID)","mutationId":null,"outcome":"needs_review","headline":"Needs review","destination":null,"insertedContent":[],"actions":[],"reasonCodes":\#(encodedReasonCodes),"createdAt":"2026-09-01T12:00:01Z"}}"#
